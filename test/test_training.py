...
class TrainingTestCase(unittest.TestCase):
    ...
    def test_evaluate_batch(self):
        self.run_basic_test(2, train.evaluate_batch, 0.01, 100, 1)

    def test_evaluate_frame(self):
        self.run_basic_test(1, train.evaluate_frame, 0.01, 100, 1)

    def test_evaluate_frame_naive(self):
        self.run_basic_test(1, train.evaluate_frame_naive)
